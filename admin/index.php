...
<head>
    ...
    <title>Electronic Shopping</title>
            ...
            <div class="sidebar">
                ...
                with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="index.php?page=add_categories" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Add Categories</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="index.php?page=manage_categories" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Manage Cotegories</p>
                                    </a>
                                </li>
                  ...
                  <a href="pages/forms/validation.html" class="nav-link">
                    ...
                    <p>Validation</p>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="index.php?page=add_products" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Add Products</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="index.php?page=manage_products" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Manage Products</p>
                                    </a>
                                </li>
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <?php
                            $adminPage_title = 'By OES';
                            if (isset($_REQUEST['page'])) {
                                $page = $_REQUEST['page'];

                                if ($page == 'add_categories') {
                                    $adminPage_title = 'Add Categories';
                                } else if ($page == 'manage_categories') {
                                    $adminPage_title = 'Manage Categories';
                                }
                            }
                            ?>
                            <h1 class="m-0"><?php echo $adminPage_title ?></h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <section class="content">
                ...
                if (isset($_REQUEST['page'])) {
                    ...
                    if ($_REQUEST['page'] == 'dashboard') {
                        ...
                        echo (isset($categories) && !empty($categories)) ? $categories->managecategories() : "Error: ". __FILE__ . ':' . __LINE__;
